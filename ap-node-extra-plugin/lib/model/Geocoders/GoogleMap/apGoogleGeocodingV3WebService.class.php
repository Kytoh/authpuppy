<?php
/**
 * apGoogleGeocodingV3WebService
 * 
 * Class used to geocode an address using the Google Geocoding V3 Web service
...
class apGoogleGeocodingV3WebService extends apGeocoderAbstract {
  ...
  public function addJavascriptFiles(sfWebResponse &$response) {
    $response->addJavascript('/apNodeExtraPlugin/js/hotspots_map_google.js');
    $response->addJavascript('http://maps.google.com/maps/api/js?sensor=false');
  }
  
  public function getJavascriptClass() {
    return "GoogleHotspotMap";
  }
